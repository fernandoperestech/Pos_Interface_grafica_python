...
class Database:
    ...
    def popular_tabelas_iniciais(self):
        try:
            result_negociacao = (Database.query_data('tipo_negociacao'))
            ...
            result_status = (Database.query_data('tipo_imovel'))
            if len(result_status)==0:
            ...
            result_status = (Database.query_data('tipo_relacao'))
            if len(result_status)==0:
            ...
            result_status = (Database.query_data('estado'))
            if len(result_status)==0:
            ...
            result_status = (Database.query_data('cidade'))
            if len(result_status)==0:
            ...
            result_status = (Database.query_data('bairro'))
            if len(result_status)==0:
